...
GOOGLE_SERVER_KEY = 'AIzaSyD_qXwIeuGPmnhRaecw-sSjzDLwmsCZGbg'

STRIPE_SECRET_KEY = 'sk_test_n57zUgRQ7TvNKhPUoKKI3nNy'
STRIPE_PUBLIC_KEY = 'pk_test_XSL2saGHkUJcJkOTk8PtVcwQ'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.10/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'g&l+@sy%t5#9$57(n30^ak2rb4un8!3ds)(3+p!m(80x8^=x$c'
